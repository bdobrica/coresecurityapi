...
#pagina 1 = contract
	for ($copy = 0; $copy < $copies; $copy++) {
		...
		$pdf->style ();
		$pdf->MultiCell (0, $h, $pdf->fix('Părțile contractante vor depune toate diligențele pentru rezolvare pe cale amiabilă a neînțelegerilor ce se pot ivi între ele cu ocazia executării contractului.'), 0, 1);
		...
		$pdf->style ();
		$pdf->MultiCell (0, $h, $pdf->fix('Prezentul contract reprezintă acordul de voință al părților și a fost încheiat astăzi, '.date('d/m/Y', $cnfpa_begin).' în două exemplare, din care unul pentru furnizor și unul pentru beneficiar.'), 0, 1);
