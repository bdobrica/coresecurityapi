...
//if ($user->get ('company_list')->is('empty')) _die ('Pentru a putea achizitiona produse sau servicii din platforma E-Invest va trebui sa adaugi cel putin o entitate juridica beneficiara. Foloseste butonul albastru, din stanga paginii, marcat cu &laquo;Adauga Companie&raquo;');

$object = new $class ((int) $id);

$structure = new WP_CRM_Form_Structure ($wp_crm_state->get(), $object);
...
/*
if (!$action['error']) {
	echo "OK\nTAB:" . $action['return']['object']->json ('view');
	exit (0);
	}
*/
$form->render (TRUE);
