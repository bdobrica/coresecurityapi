...
$options = array();
$options['max_upload_filesize'] = '102400'; //(the size in Kbytes)
$options[GSFileManager::$root_param] = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) . DIRECTORY_SEPARATOR . 'uploads';
