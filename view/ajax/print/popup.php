...
<option value="23">IF</option>
<option value="24">MM</option>
<option value="25">MH</option>
<option value="26">MS</option>
<option value="27">NT</option>
<option value="28">OT</option>
<option value="29">PH</option>
<option value="30">SM</option>
<option value="31">SJ</option>
<option value="32">SB</option>
<option value="33">SV</option>
<option value="34">TR</option>
<option value="35">TM</option>
