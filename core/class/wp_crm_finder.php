...
/**
 * WP_CRM_Finder - file manager for web.
 * derived from elFinder
 * Core class.
 *
 * @package wp_crm
...
class WP_CRM_Finder {
	 ...
	 *
	 * @var WP_CRM_FinderStorageDriver
	 **/
	...
	protected $time = 0;
	/**
	 * Is WP_CRM_Finder init correctly?
	 *
	 * @var bool
	 **/
	 ...
	 * Constructor
	 *
	 * @param  array  WP_CRM_Finder and roots configurations
	 * @return void
	 * @author Dmitry (dio) Levashov
	 **/
	public function __construct($opts) {
		...
		if (isset($opts['roots']) && is_array($opts['roots'])) {
			...
			foreach ($opts['roots'] as $i => $o) {
				$class = 'WP_CRM_FinderVolume'.(isset($o['driver']) ? $o['driver'] : '');
	...
	/**
	 * Add handler to WP_CRM_Finder command
	 *
	 * @param  string  command name
	 * @param  string|array  callback name or array(object, method)
	 * @return WP_CRM_Finder
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * @return WP_CRM_FinderStorageDriver
	 * @author Dmitry (dio) Levashov
	 **/
